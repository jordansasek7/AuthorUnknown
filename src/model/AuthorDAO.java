...
//    ORG: COP 3003
//    Date: 12/12/2018
//    DESC: AuthorDAO will work with the View and Controller packages to create a usable Gui
//    database to perform specific SQL statements for a user.
...
public class AuthorDAO {
  ...
  public static void deleteAuthWithId(String authId) throws SQLException, ClassNotFoundException {
    ...
    String updateStmt =
        "DELETE FROM AUTHORS " +   "WHERE AUTHORID =" + authId;
